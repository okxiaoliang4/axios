...
export const kindOf = (function(cache) {
  // eslint-disable-next-line func-names
...
export function kindOfTest(type) {
 ...
 */
export function isFormData(thing) {
 ...
 * @returns {void}
 */
export function inherits(constructor, superConstructor, props, descriptors) {
 ...
 * @returns {Object}
 */
export function toFlatObject(sourceObj, destObj, filter, propFilter) {
  var props;
  var i;
  var prop;
  var merged = {};
 ...
 * @returns {void}
 */
export function forEachEntry(obj, fn) {
